...
$.extend( $.validator, {
	...
	messages: {
		...
		digits: "Por favor ingresa solo los dígitos.",
		creditcard: "Por favor ingresa una tarjeta de crédito válida.",
		equalTo: "Por favor ingresa el mismo valor de nuevo.",
		maxlength: $.validator.format( "Puedes ingresar máximo {0} caracteres en este campo" ),
		minlength: $.validator.format( "Debes ingresar mínimo {0} caracteres en este campo." ),
